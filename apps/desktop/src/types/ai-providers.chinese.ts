...
export const CHINESE_PROVIDERS: ProviderConfig[] = [
  {
    ...
    models: [
      ...
      },
      {
        ...
        providerId: 'qwen',
        contextWindow: 8192,
        capabilities: { text: true, image: true, functionCall: false, vision: true }
      }
    ]
  },
  {
    ...
    models: [
      ...
      },
      {
        ...
        providerId: 'deepseek',
        contextWindow: 16384,
        capabilities: { text: true, image: false, functionCall: false, vision: false },
        price: { input: 0.14, output: 0.28 }
      }
    ]
  },
    ...
    models: [
      {
        id: 'MiniMax-M2.7',
        name: 'MiniMax-M2.7',
        description: '强大多语言编程实力，全面升级编程体验 (约60tps)',
        providerId: 'minimax',
      ...
      },
      {
        ...
        description: 'M2.7 极速版：更快，更敏捷 (约100tps)',
        providerId: 'minimax',
        contextWindow: 245760,
        capabilities: { text: true, image: false, functionCall: true, vision: false }
      }
