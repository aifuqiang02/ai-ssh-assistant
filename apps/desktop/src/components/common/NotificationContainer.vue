<template>
  <div class="notification-container fixed bottom-1 right-1 z-50 space-y-2 w-full max-w-[600px]">
    <transition-group name="notification" tag="div">
      <div
        v-for="notification in notifications"
        :key="notification.id"
        :class="[
          'notification-item w-full bg-white dark:bg-gray-800 shadow-lg rounded-lg pointer-events-auto ring-1 ring-black ring-opacity-5 overflow-hidden',
      ...
      >
        ...
        >
          <div
            :class="['h-full transition-all ease-linear', getProgressBarClass(notification.type)]"
            :style="{
